...
/**
 * REST controller for managing {@link com.memoire.kital.raph.domain.Enseignant}.
 */
@RestController
@RequestMapping("/api")
public class EnseignantResource {
    ...
    private static final String ENTITY_NAME = "coursEnseignant";
    ...
    public ResponseEntity<EnseignantDTO> updateEnseignant(@Valid @RequestBody EnseignantDTO enseignantDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, enseignantDTO.getId().toString()))
            .body(result);
    }
